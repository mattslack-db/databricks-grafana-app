...
BASE_ENV = {
    ...
    "LAKEBASE_DB_USER": "matt.slack@databricks.com",
...
def test_load_config_parses_required_fields():
    ...
    assert cfg.db_user == "matt.slack@databricks.com"
...
def test_load_config_host_set_when_env_provided():
    env = {**BASE_ENV, "LAKEBASE_HOST": "ep-lucky-tree-d25raxtv.database.us-east-1.cloud.databricks.com"}
    cfg = load_config(env)
    assert cfg.host == "ep-lucky-tree-d25raxtv.database.us-east-1.cloud.databricks.com"
